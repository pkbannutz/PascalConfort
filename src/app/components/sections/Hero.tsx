          ...
          <ScrollReveal direction="left">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                ...
                <span className="block text-blue-900">Urgențe Non-Stop</span>
              </h1>
          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="relative">
              ...
              <ScrollReveal direction="up" delay={0.4}>
                <div className="absolute -top-4 -left-4 bg-orange-500 text-white px-4 py-2 rounded-lg shadow-lg">
                  <div className="text-sm font-semibold">ANRE Autorizat</div>
                </div>
              </ScrollReveal>
